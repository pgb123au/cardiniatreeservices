# Heritage Springs Tree Services &amp; Pergolas — rank-and-rent microsite
...
| Item | Value |
|---|---|
| Domain | `cardiniatreeservices.com.au` (registered, GoDaddy fraud-pending) |
| Live URL (interim) | https://cardiniatreeservices.netlify.app |
...
├── whisper.js                # "Pete's Lead from Heritage Springs Tree Services &amp; Pergolas" played to contractor before patching caller through
...
| `TENANT_BRAND` | `Heritage Springs Tree Services &amp; Pergolas` (default) | What plays after the label — full whisper is `"Pete's Lead. Pete's Lead from Heritage Springs Tree Services &amp; Pergolas."` |
...
3. Submit to Google Search Console (`sc-domain:cardiniatreeservices.com.au`).
4. Set up Google Business Profile (needs registered business name "Heritage Springs Tree Services &amp; Pergolas" first).
5. Backlink work: hipages directory, True Local AU, Yelp AU, Heritage Springs Shire community pages.
