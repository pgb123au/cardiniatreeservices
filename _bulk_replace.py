"""Bulk find/replace + page rename for Heritage Springs Tree Services & Pergolas scaffold."""
...
REPLACEMENTS = [
    ("https://geelongroofrestorations.com.au", "https://cardiniatreeservices.com.au"),
    ("geelongroofrestorations.com.au", "cardiniatreeservices.com.au"),
    ("geelongroofrestorations", "cardiniatreeservices"),
    ("Geelong Roof Restorations", "Heritage Springs Tree Services &amp; Pergolas"),
    ...
    ("Geelong, the Bellarine and the Surf Coast", "Pakenham, Heritage Springs Lakes and the Heritage Springs Hills"),
    ("Geelong, the Bellarine, and the Surf Coast", "Pakenham, Heritage Springs Lakes, and the Heritage Springs Hills"),
    ...
    ("/services/roof-painting/", "/services/tree-lopping/"),
    ("/services/tile-restoration/", "/services/stump-grinding/"),
    ...
    ("Armstrong Creek", "Emerald"),
    ("Lara", "Pakenham"),
    ("quotes@geelongroofrestorations.com.au", "quotes@cardiniatreeservices.com.au"),
    (">G</text>", ">P</text>"),
]
...
def main():
    ...
    if pkg.exists():
        ...
        s = s.replace('"name": "geelongroofrestorations"', '"name": "cardiniatreeservices"')
